...
<head>
    ...
    <link href="{{asset("font-awesome/font.css")}}" rel="stylesheet" type="text/css">
    <link
        ...
        <li class="nav-item">
            ...
            <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{route('table.category')}}">Categories</a>
                    <a class="collapse-item" href="{{route('table.product')}}">Products</a>
                </div>
            </div>
        </li>
