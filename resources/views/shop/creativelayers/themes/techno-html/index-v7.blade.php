...
<!-- Mirrored from creativelayers/themes/techno-html/index-v7.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Nov 2021 18:16:24 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="UTF-8">
    <!--[if IE]>
    <meta http-equiv='X-UA-Compatible' content='IE=edge,chrome=1'><![endif]-->
    <title>Techno Store - Home 7</title>
...
<!--    </div>&lt;!&ndash; /.preloader &ndash;&gt;-->
                                ...
                                <div class="box-search">
                                    ...
                                    <span class="btn-search">
												<button type="submit" class="waves-effect"><img
                                                        src="images/icons/search-2.png" alt=""></button>
											</span>
                                </div><!-- /.box-search -->
                            </form><!-- /.form-search -->
                        </div><!-- /.top-search -->
    ...
    <section class="flat-row flat-slider style5">
        <div class="container">
            <div class="row">
                <div class="col-lg-3">
                </div><!-- /.col-lg-3 -->
                        ...
                        <div class="slider-item style7">
                            <div class="item-text">
                                <div class="header-item">
                                    <p>iPhone 7</p>
                                    <h2 class="name">Now in <span>Red</span></h2>
                                    <p>The ship set ground on the shore of this uncharted desert isle <br/>with Gilligan
                                        the Skipper too the millionaire and his story. </p>
                                </div>
                                <div class="content-item">
                                    <div class="price">
                                        <span class="sale">$3.568.99</span>
                                        <span class="btn-shop">
                            ...
                            <div class="item-image">
                                <img src="images/slider/08.png" alt="">
                            </div>
                        </div><!-- /.slider-item style7 -->
                        <div class="slider-item style7">
                            <div class="item-text">
                                <div class="header-item">
                                    <p>iPhone 7</p>
    ...
    <section class="flat-imagebox style2 v1">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="product-wrap">
                        <div class="product-tab style1 v1">
                            <ul class="tab-list">
...
<!-- Mirrored from creativelayers/themes/techno-html/index-v7.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Nov 2021 18:17:30 GMT -->
</html>
